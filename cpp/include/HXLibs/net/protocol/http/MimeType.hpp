...
struct Less {
    bool operator()(std::string_view s1, std::string_view s2) const {
        return std::lexicographical_compare(
            ...
            [](unsigned char const &c1, unsigned char const &c2) { // 忽略大小写
 ...
 * @param extension 文件拓展名, 如`.zip`
 * @return std::string_view 
 */
inline std::string_view getMimeType(std::string_view extension) {
    using namespace std::string_view_literals;
    auto it = internal::mimeMap.find(extension);
    if (it == internal::mimeMap.end()) {
